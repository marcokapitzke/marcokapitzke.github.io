...
This site uses a small set of locally hosted editorial hover images in the Selected Work section. They are used as subtle contextual backgrounds, not as claims that the pictured people, labs, or institutions are connected to Marco A. Kapitzke.

## Selected Work Hover Images

- `public/work-infineon.jpg`  
  Source: [Silicon wafer.jpg](https://commons.wikimedia.org/wiki/File:Silicon_wafer.jpg) by Inductiveload, Wikimedia Commons. Public domain dedication by the copyright holder.

- `public/work-flups.jpg`  
  Source: [Femtosecond Laser and Pulse Compressor - Optics Lab - INRIM.jpg](https://commons.wikimedia.org/wiki/File:Femtosecond_Laser_and_Pulse_Compressor_-_Optics_Lab_-_INRIM.jpg) by Giorgio Brida, via Wikimedia Commons / Flickr. Licensed under [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/). Cropped/resized for web display.

- `public/work-columbia.jpg`  
  Source: [Clean room.jpg](https://commons.wikimedia.org/wiki/File:Clean_room.jpg), NASA Glenn Research Center, via Wikimedia Commons. Public domain as a NASA image.
